...
const AuditForm = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      // Enviamos todos los datos del cuestionario
      ...
      // Redirección a la página de formación en la carpeta public
    ...
    <div className="w-full max-w-[640px] mx-auto px-4 mt-8 pb-10">
      <div className="forms-card mb-4 overflow-hidden">
        ...
        <div className="p-8">
          ...
          <p className="text-sm">Expediente SecureCheck SC-2026-882</p>
        </div>
      </div>
      ...
      <div className="forms-card p-6 mb-4">
        ...
        {["1-10", "11-50", "50+"].map(opt => (
          <label key={opt} className="flex items-center gap-3 mb-3 cursor-pointer">
